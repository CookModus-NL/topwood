    ...
    <footer className="mt-32 border-t border-ink-700/50">
      <div className="container-x py-20 grid grid-cols-1 md:grid-cols-12 gap-14">
        ...
        <div className="md:col-span-3">
          <div className="eyebrow mb-5">Site</div>
        ...
        <div className="md:col-span-4">
          ...
          <ul className="space-y-3 text-[14px] text-ink-50">
            <li>
              <a href={`tel:${business.phoneE164}`} className="hover:text-sand-300 font-display text-lg tracking-widest">
                {business.phone}
              </a>
            </li>
            <li>
            ...
            {business.social.instagram && (
              <li>
                <a href={business.social.instagram} target="_blank" rel="noreferrer" className="hover:text-sand-300 link-line">
